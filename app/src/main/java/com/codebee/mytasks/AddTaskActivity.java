...
public class AddTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                ...
                if (calendar1.getTime().compareTo(calendar.getTime()) > 0) {
                    time = hour + ":" + min;
                    ((TextView) findViewById(R.id.add_task_time_text)).setText(time);
                } else {
        ...
        onDateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                if (isAfterToday(d, m, y)) {
                    date = d + "/" + (m + 1) + "/" + y;
                    ((TextView) findViewById(R.id.add_task_date_text)).setText(date);
                    time = "";
                    ((TextView) findViewById(R.id.add_task_time_text)).setText("Choose a time");
                } else {
        ...
        findViewById(R.id.add_task_back_image).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.add_task_save_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!((EditText) findViewById(R.id.add_task_label_text)).getText().toString().trim().isEmpty() &&
                    ...
                    if(date.isEmpty()){
                        ((TextView)findViewById(R.id.add_task_date_text)).setError("Please choose a date first.");
                    }
                    if(time.isEmpty()){
                        ((TextView)findViewById(R.id.add_task_time_text)).setError("Please choose a time first.");
                    }
                }
            }
        });

        findViewById(R.id.add_task_date_text).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar calendar = Calendar.getInstance();
        ...
        findViewById(R.id.add_task_time_text).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (date.isEmpty()) {
